                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center space-x-2">
                      <span
                        className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${statusColors[ticketData.status]}`}
                      >
                        {ticketData.status.replace("_", " ")}
                      </span>
                      <span
                        className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${priorityColors[ticketData.priority]}`}
                      >
              ...
              <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
                <div className="flex items-center justify-between text-sm text-gray-500">
                  <div className="flex items-center">
                    ...
                    Created{" "}
                    {formatDistanceToNow(new Date(ticketData.createdAt), {
                      addSuffix: true,
                    })}
                  </div>
                  {ticketData.updatedAt && (
                    <div className="flex items-center">
                      ...
                      Updated{" "}
                      {formatDistanceToNow(new Date(ticketData.updatedAt), {
                        addSuffix: true,
                      })}
                    </div>
                  )}
